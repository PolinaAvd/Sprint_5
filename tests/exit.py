...
driver.find_element(By.XPATH, ".//ul[@class='Account_list__3KQQf mb-20']//button[text()='Выход']").click()

WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, ".//form[@class='Auth_form__3qKeq mb-20']//button[text()='Войти']")))
